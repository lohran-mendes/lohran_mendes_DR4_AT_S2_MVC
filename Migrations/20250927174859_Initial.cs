    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DestinosPacotes", x => x.id);
                    table.ForeignKey(
                        name: "FK_DestinosPacotes_Destinos_DestinoId",
                        column: x => x.DestinoId,
                        principalTable: "Destinos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DestinosPacotes_PacotesTuristicos_PacoteTuristicoId",
                        column: x => x.PacoteTuristicoId,
                        principalTable: "PacotesTuristicos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DestinosPacotes_DestinoId",
                table: "DestinosPacotes",
                column: "DestinoId");

            migrationBuilder.CreateIndex(
                name: "IX_DestinosPacotes_PacoteTuristicoId",
                table: "DestinosPacotes",
                column: "PacoteTuristicoId");
